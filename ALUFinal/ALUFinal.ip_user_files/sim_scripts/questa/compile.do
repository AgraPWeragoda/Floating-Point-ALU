...
vlog -work xpm  -incr -mfcu  -sv "+incdir+D:/Xilinx/2025.1/Vivado/data/rsb/busdef" \
"D:/Xilinx/2025.1/Vivado/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \

vcom -work xpm  -93  \
"D:/Xilinx/2025.1/Vivado/data/ip/xpm/xpm_VCOMP.vhd" \

vlog -work xil_defaultlib  -incr -mfcu  "+incdir+D:/Xilinx/2025.1/Vivado/data/rsb/busdef" \
