...
#
# Script generated by Vivado on Sun Dec 14 22:39:20 +0530 2025
...
#
# Usage        : core.sh
#                core.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                core.sh [-reset_run]
#                core.sh [-reset_log]
#                core.sh [-help]
#
...
# script info
echo -e "core.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./core.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot core xil_defaultlib.core xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim core -key {Behavioral:sim_1:Functional:core} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb core.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./core.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: core.sh [-help]\n\
Usage: core.sh [-step]\n\
Usage: core.sh [-lib_map_path]\n\
Usage: core.sh [-reset_run]\n\
Usage: core.sh [-reset_log]\n\
Usage: core.sh [-keep_index]\n\
Usage: core.sh [-noclean_files]\n\n\
