...
HD_PWD='C:/Users/Agrajith/Desktop/Sem 5/Digital System Design/ALUFinal/ALUFinal/ALUFinal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_alu_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_uart_alu_system.tcl -notrace
