...
HD_PWD='C:/Users/Agrajith/Desktop/Sem 5/Digital System Design/ALUFinal/ALUFinal/ALUFinal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_alu_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_uart_alu_system.tcl
