...
REM
REM Generated by Vivado on Sun Dec 14 12:02:18 +0530 2025
...
echo "xvlog --incr --relax -prj ledDisplay_vlog.prj"
call xvlog  --incr --relax -prj ledDisplay_vlog.prj -log xvlog.log
