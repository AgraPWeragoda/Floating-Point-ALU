...
HD_PWD='C:/Users/Agrajith/Desktop/Sem 5/Digital System Design/ALUFinal/ledOutput/ledOutput.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ledDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ledDisplay.tcl
