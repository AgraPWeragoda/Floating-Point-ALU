...
HD_PWD='C:/Users/Agrajith/Desktop/Sem 5/Digital System Design/ALUFinal/ledOutput/ledOutput.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ledDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ledDisplay.tcl -notrace
